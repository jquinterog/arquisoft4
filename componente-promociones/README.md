...
```bash
uvicorn componente_promociones.main:app --reload
```
...
## Imagen para Kubernetes

Desde este directorio:

```bash
docker build -t arquisoft/componente-promociones:local .
```

La variable requerida para ejecutar el contenedor es:
